    ...
    class ComportamientoAg4 extends CyclicBehaviour {
        ...
        public void action() {
            ...
            try {
                ...
                System.out.println("Hola agente 2, soy Agente 4, recibí lo siguiente: " + aclMSJ2.getContentObject() + " " + aclMSJ2.getConversationId()+" "+aclMSJ2.getSender());
                ...
                System.out.println("Hola agente"+aclMSJ.getSender().getLocalName()+" , soy Agente 4, recibí lo siguiente: " + aclMSJ.getConversationId() + " " + aclMSJ.getContentObject()+" "+aclMSJ.getSender());
